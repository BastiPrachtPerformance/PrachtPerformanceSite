...
final class PrachtSuite
{
    ...
    private static function generatePdf(int $orgId, int $invoiceId): string
    {
        ...
        $pdf->line($page,42,78,553,78,$rule); $pdf->wrapped($page,42,60,230,$footer ?: 'Vielen Dank für Ihr Vertrauen.',7,$muted); $pdf->wrapped($page,308,60,112,implode("\n",$bank),7,$muted); $pdf->wrapped($page,442,60,111,implode("\n",$legal),7,$muted);
