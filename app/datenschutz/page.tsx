...
export default function Datenschutz() {
  return <main className="legal-page">
    ...
    <article className="container legal-content">
      ...
      <section><h2>Verantwortlicher</h2><p><strong>David Pracht / Pracht Performance</strong><br />Obere Erlentiefenstraße 28<br />59192 Bergkamen<br />Telefon: <a href="tel:+4915904047342">+49 159 04047342</a><br />E-Mail: <a href="mailto:info@pracht-performance.de">info@pracht-performance.de</a></p></section>
      ...
      <section><h2>Cookies und ähnliche Technologien</h2><p>Diese Website setzt derzeit keine Analyse-, Marketing- oder sonstigen einwilligungspflichtigen Cookies ein. Soweit technisch notwendige Speicherungen oder Sicherheitsmechanismen erforderlich sind, erfolgen diese auf Grundlage von § 25 Abs. 2 TDDDG und Art. 6 Abs. 1 lit. f DSGVO. Wenn künftig optionale Dienste, eingebettete Inhalte oder Tracking eingesetzt werden, wird diese Erklärung aktualisiert und eine erforderliche Einwilligung eingeholt.</p></section>
