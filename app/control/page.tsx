...
export default function ControlPage() {
  ...
  if (!selectedSite) return <main className="control-login-shell"><section className="control-login-card"><p className="control-kicker">Pracht Control</p><h1>Daten werden<br /><em>geladen.</em></h1></section></main>;
