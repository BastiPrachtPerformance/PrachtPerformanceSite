...
export function ScrollEffects() {
  ...
  useEffect(() => {
    ...
    const targets = Array.from(document.querySelectorAll<HTMLElement>("main > section, .client-logo, .reference-card, .detail-service, .approach-steps article, .project-row, .service-columns a"));
