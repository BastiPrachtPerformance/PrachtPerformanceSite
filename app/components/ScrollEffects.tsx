...
export function ScrollEffects() {
  ...
  return <><div className={`site-loader ${ready ? "is-ready" : ""}`} aria-hidden="true"><span>P/</span><i /><b>PRACHT PERFORMANCE</b></div><div className="scroll-progress" aria-hidden="true"><i /></div><div className="cursor-cross" ref={cursorRef} aria-hidden="true"><i /><b /><em>P/</em></div></>;
}
