...
export function ScrollEffects() {
  ...
  useEffect(() => {
    ...
    const targets = Array.from(document.querySelectorAll<HTMLElement>("main > section:not(.edition-hero), .client-logo, .reference-card, .detail-service, .approach-steps article, .project-row, .service-columns a"));
    ...
    const editionGrid = document.querySelector<HTMLElement>(".edition-grid");
    const editionScroll = document.querySelector<HTMLElement>(".edition-scroll");
    let frame = 0;
    const updateMotion = () => {
      frame = 0;
