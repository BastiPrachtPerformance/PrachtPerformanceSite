...
const clients = [
  ["ennovex", "Energieverwaltung", "/clients/ennovex.png"], ["PIECHA", "Automotive", "/clients/piechalogo.png"], ["ZIZOU", "Fashion", "/clients/zizou.gif"],
  ["VHG", "Dirk Grosser", "/clients/logo5.png"], ["urlaubduhnen.de", "MEERzeit", "/clients/ogo7.webp"], ["Podologie", "Gesundheit", "/clients/podologie.png"],
];

export default function Home() {
  return <main>
    <section className="hero" id="top"><div className="grain" aria-hidden="true" /><div className="orb orb-one" data-parallax="0.06" aria-hidden="true" /><div className="orb orb-two" data-parallax="-0.05" aria-hidden="true" /><div className="particles" aria-hidden="true">{Array.from({ length: 22 }, (_, index) => <i key={index} />)}</div>
      <SiteHeader />
